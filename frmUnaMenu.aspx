<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmUnaMenu.aspx.cs" Inherits="frmUnaMenu" %>
                                ...
                                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td valign="top" align="center">
                                            <div id="divContent">
                                                <asp:Button ID="btnRental" runat="server" Text="Unallocated Rentals"
                                                    OnClick="btnRental_Click" />
                                                <asp:Button ID="btnUna"
                                                    runat="server" Text="Unallocated Statements" OnClick="btnUna_Click" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
